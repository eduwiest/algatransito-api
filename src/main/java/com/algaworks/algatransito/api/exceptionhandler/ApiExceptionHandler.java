...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        //Adicionando campos customizados no Problem Detail se falatar algum campo avisa
    ...
    public ProblemDetail handlerNegocio(NegocioException e) {
        ...
        problemDetail.setType(URI.create("http://algatransito.com/erros/regra-de-negocios"));
